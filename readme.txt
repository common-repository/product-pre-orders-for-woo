...
- [Getting Started](http://docs.villatheme.com/?item=woocommerce-product-pre-orders)
...
1. Upload `product pre-orders-for-woocommerce` to the `/wp-content/plugins/` directory
...
1. Setting admin
2. Setting Product
3. show outside the store
4. Display in single product
5. Displayed on cart
